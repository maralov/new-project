window.addEventListener('scroll', function(){
  var el                = document.querySelector('.about__text'),
      topOfWindow       = window.pageYOffset || el.documentElement.scrollTop;
  if (topOfWindow - 200) {
    el.classList.add('about__text--show');
  }
});
// взято с http://shpargalkablog.ru/2014/10/smooth-scrolling.html))
